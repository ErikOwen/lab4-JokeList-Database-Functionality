...
public class JokeContentProvider extends ContentProvider {
	...
	public boolean onCreate() {
		this.database = new JokeDatabaseHelper(getContext(), JokeDatabaseHelper.DATABASE_NAME, null, JokeDatabaseHelper.DATABASE_VERSION);
		return true;
	}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch(uriType) {
        	case JOKE_ID:
                String jokeToDelete = uri.getLastPathSegment();
                rowsDeleted = sqlDB.delete(JokeTable.DATABASE_TABLE_JOKE, JokeTable.JOKE_KEY_ID + "=" + jokeToDelete, null);
            break;
            default:
            	throw new IllegalArgumentException("Unknown URI: " + uri);
         }
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch(uriType) {
            case JOKE_ID:
            	String jokeToDelete = uri.getLastPathSegment();
            	rowsUpdated = sqlDB.update(JokeTable.DATABASE_TABLE_JOKE, values, JokeTable.JOKE_KEY_ID + "=" + jokeToDelete, null);
            break; 
            default:
            	throw new IllegalArgumentException("Unknown URI: " + uri);
        }
